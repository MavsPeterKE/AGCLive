...
public class EndDayAdapter extends RecyclerView.Adapter<EndDayAdapter.GenericViewHolder> {

    private int layoutId;
    private List<EndDayModel> endDayModelList;
    private EndDayViewModel viewModel;

    public EndDayAdapter(@LayoutRes int layoutId, EndDayViewModel viewModel) {
