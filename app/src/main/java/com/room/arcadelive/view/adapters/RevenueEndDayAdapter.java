...
public class RevenueEndDayAdapter extends RecyclerView.Adapter<RevenueEndDayAdapter.GenericViewHolder> {

    private int layoutId;
    private List<EndDayModel> endDayModelList;
    private EndDayViewModel viewModel;

    public RevenueEndDayAdapter(@LayoutRes int layoutId, EndDayViewModel viewModel) {
    ...
    class GenericViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(EndDayViewModel viewModel, Integer position) {
